...
if($_SESSION["groupid"] == 1)
{
	if(!isset($_POST["change"]))
	{
		...
		#########################################################
		echo '<br /><b>Keine Daten geändert!</b><br />';
	...
	if(isset($_POST["change"]))
	{
		echo '<br /><b>Daten werden geändert!</b><br />';
		...
		*/
		...
		// mysql_query($query2, $dbconnection) or die(mysql_error());
		// echo '<br />nach zweitem query<br />';
